<template>
    <div class="bg-white">
        ...
        <div class="product-container px-3 pb-3">
            <div class="row">
                <div class="left-Col col-4 mb-4 d-flex">
                    ...
                    <div class="ms-2 ">
                        <img :src="getProductImage(product.image)" class=""
                            style="max-width: 300px; max-height: 400px;">
                    </div>
                </div>
                <div class="center-Col col-6 mb-3">
                ...
                <div class="right-Col col-2 mb-3">
                    <div class="mb-1">
                        <span class="position-relative">
                            <span class="position-absolute top-n10">$</span>
                            <span class="fs-3 ms-2">{{ salePricePart.saleiInteger }}</span>
